...
export function HeroSection() {
  return (
    <section className="px-4 pt-8 sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-8 rounded-[36px] bg-[linear-gradient(135deg,#fff8ef_0%,#ffffff_40%,#e8f5ff_100%)] p-8 shadow-[0_25px_80px_-40px_rgba(15,23,42,0.25)] lg:grid-cols-[1.2fr_0.8fr] lg:p-12">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
          ...
          <div className="rounded-[28px] bg-orange-500 p-6 text-white">
